...
public class TeamCompetence {
    ...
    public static TeamCompetence create(RawJson rawJson) {
    ...
    public static TeamCompetence create(String jsonString) {
        Assert.notNull(jsonString, "rawJsonString은 null일 수 없습니다.");

        TeamCompetence teamCompetence = new TeamCompetence();
        teamCompetence.rawJson = RawJson.create(jsonString);
