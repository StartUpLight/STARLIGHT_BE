...
public record BusinessPlanResult() {
    ...
    public record Detail(
            ...
            String title,
            PlanStatus planStatus,
            List<SubSectionResult.Detail> subSectionDetailList
    ) {
    ...
    public record PreviewPage(
        ...
        public static PreviewPage from(List<BusinessPlanResult.Preview> content, Page<?> page) {
            return new BusinessPlanResult.PreviewPage(
                    content,
                    page.getNumber() + 1,
                    page.getSize(),
                    page.getTotalPages(),
